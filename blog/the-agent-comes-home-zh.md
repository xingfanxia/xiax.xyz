...
这个系列从[一个 AI 伴侣的愿景](/the-companion-vision-zh)写到了[范式转移已经发生](/the-printing-press-moment-zh)。九篇文章，每一篇都在拼一块拼图。

最后这一块是：代码学会了自我进化。当 Agent 理解自己的源代码，闭环就完成了——它不再需要你告诉它怎么做，它自己搞定。

Peter 用一小时做出了 OpenClaw。三个月后，17.5万颗星，没有风投。软件在自我重写。
