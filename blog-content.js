...
var BLOG_CONTENT = {
    ...
    "claudecode-zh": [
        ...
        "",
        "2025年初，我开始用 Claude Code 搭建盘盘猫的开发环境。那时候它还需要大量手动引导——但我已经能感觉到，它和 Copilot 那种\"自动补全\"是完全不同的东西。",
        "",
        "2025年中，它开始能处理完整的 feature 开发——从理解需求到写代码、写测试、部署。我的角色从\"写代码的人\"变成\"审代码的人\"。",
        "",
        "2025年底到2026年初，变化加速了。我在 GCP 上搭了 OpenClaw，把 Agent 接入飞书，非技术团队成员开始直接和 Agent 协作（[第五篇](/the-last-mile-of-ai-zh)写了这个）。Anthropic 推出 Cowork。SemiAnalysis 发报告。顶尖开发者集体表态。",
        "",
        "这个转折不是某一天突然发生的。它像水温升高——你每天都泡在里面，感觉不到变化。但如果2024年的我看到2026年的我，他会认不出我的工作方式。",
        "",
