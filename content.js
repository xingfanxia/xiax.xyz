    ...
    var home = [
        ...
        },
        {
            ...
            output: [
                ...
                '<span class="output-green">\u25A0</span> <span class="output-bold">24B+ tokens</span> burned across agentic coding sessions',
        ...
        {
            cmd: 'token-tracker --summary',
            live: 'token-usage',
            output: [
                '',
                '  <span class="output-dim">Loading live data...</span>',
                ''
            ]
        },
        {
