...
(function() {
    ...
    var openclawSequence = [
        ...
        },
        {
            cmd: 'ls research/',
            output: [
                '<span class="output-highlight">selfie-gen/</span>      <span class="output-dim">\u2014 9 strategies tested, hybrid-s2 wins (face ref + text body)</span>',
    ...
    // Path shown in prompt for each tab
    var tabPaths = {
        'projects': '~/projects',
